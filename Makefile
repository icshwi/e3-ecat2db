...
# We don't have git submodule in this module
$(EPICS_MODULE_NAME): 
#	$(QUIET) $(git_update)
	git pull && git checkout $(EPICS_MODULE_TAG)
...
.PHONY: env $(E3_ENV_NAME) $(EPICS_MODULE_NAME) git-submodule-sync init help help2 build clean install uninstall conf rebuild db
